    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 main">
                <center>
                <h1 class="page-header"><i class="fa fa-bar-chart" aria-hidden="true"></i> Result of live polling by district name  </h1>
                </center>
                <br>
                <div class="row">
                    ...
                    <form name="form1" method="post" action="loaddetails.php" onsubmit="return loginValidate(this)">
                    <center
                    <label class="margin-top-top"><h3> District Name </label>&nbsp &nbsp
                <select name="district">
                    <?php
                    $sql=mysqli_query($con, "SELECT distinct(district) FROM partystatedatabase  ");
