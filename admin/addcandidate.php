    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 main">
                <center>
                <h1 class="page-header"><i class="fa fa-tachometer" aria-hidden="true"></i> Add Candidate</h1>
                </center>
                <div class="row">
                    <div class = "col-md-3"></div>

                    <div class = "col-md-6">
                    <form name="form1" method="post" action="addcan.php" onsubmit="return loginValidate(this)">
                <input class="form-control" type="text" placeholder="Candidate Name" name="cname">
                ...
                <input class="form-control" type="text" placeholder="Party name" name='partyname'>
